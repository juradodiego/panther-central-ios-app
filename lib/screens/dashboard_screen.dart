              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: 250,
                    width: 350,
                    child: TransactionsGraph(
                        user, getCurrentToggle(_selectedToggle)),
                  ),
                  const SizedBox(
                    height: 15,
                  ),
...
Widget createTransactionList(UserViewModel user, String toggle) {
  // call the function to get the list of transactions based on the toggle
  List<Transaction> transactions = user.filterTransactions(toggle);
  return Container(
      width: 340,
      decoration: BoxDecoration(
        color: Colors.white,
